...
joblib.dump(clf, 'models/prima/prima-model-{}-{}.joblib'.format(criterion_var_chosen,max_depth_var))
...
graph.write_png('data/output/prima-{}-{}.png'.format(criterion_var_chosen,max_depth_var))
